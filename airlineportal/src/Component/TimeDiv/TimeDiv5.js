...
const TimeDiv5 = ({
  ...
  const getDepartureDate = () => {
    if (departureDateString3) {
      return parseISO(departureDateString3);
    }
    return getTomorrow();
  };
  ...
  const handleDepartureDateChange = (date) => {
    ...
    setDepartureDateString4(format(date, "yyyy-MM-dd"));
  };
  ...
  }, [departureDateString3]); // Dependency on departureDateString
  ...
  useEffect(() => {
    ...
    if (
      departureDateString4 &&
      parseISO(departureDateString4) < newDepartureDate
    ) {
      setDepartureDateString4(format(newDepartureDate, "yyyy-MM-dd"));
    }
  }, [departureDateString3, departureDateString4, setDepartureDateString4]);
