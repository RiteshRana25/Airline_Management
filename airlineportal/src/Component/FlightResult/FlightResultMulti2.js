...
const FlightResultMulti2 = ({
  ...
  return (
    <>
      <div className="overlay" onClick={closeModal2}></div>
      <div className="bookingDetails">
        ...
        <p style={{ fontSize: "20px" }}>
          ...
          {new Intl.NumberFormat("en-IN").format(totalCost2 * totalTraveler)}
        </p>
        ...
        >
          ...
          <button onClick={completeBooking2}>Book</button>
        </div>
      </div>
...
export default FlightResultMulti2;
