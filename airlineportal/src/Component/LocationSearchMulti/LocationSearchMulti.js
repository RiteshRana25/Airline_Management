...
const LocationSearchMulti = ({
  ...
  const handleSelectFrom = (airport) => {
    if (airport.address.cityCode === selectedTo.code) {
      ...
      setError_1("From and To airports cannot be the same.");
      return;
    }
    ...
    setResultsFrom([]);
    setError_1(""); // Clear error if selection is valid
  };
    ...
    <div className="location-container-multi">
      ...
      <div
        ...
        onClick={() => {
          ...
          setSelectedTo(temp);
          setError_1(""); // Clear error when swapping
        }}
      >
        <SwapHorizIcon />
      </div>
...
export default LocationSearchMulti;
