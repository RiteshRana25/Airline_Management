...
const apiSecret = process.env.REACT_APP_API_SECRET;
  ...
  const handleSelectFrom = (airport) => {
    if (airport.address.cityCode === selectedTo1.code) {
      ...
      setError_2("From and To airports cannot be the same.");
      return;
    }
    ...
    setResultsFrom([]);
    setError_2(""); // Clear error if selection is valid
  };
    ...
    <div className="location-container-multi">
      ...
      <div
        ...
        onClick={() => {
          ...
          setSelectedTo1(temp);
          setError_2(""); // Clear error when swapping
        }}
      >
        <SwapHorizIcon />
      </div>
...
export default LocationSearchMulti1;
