...
const FlightResultMulti1 = ({
  ...
  return (
    <>
      <div className="overlay" onClick={closeModal1}></div>
      <div className="bookingDetails">
        ...
        <p style={{ fontSize: "20px" }}>
          ...
          {new Intl.NumberFormat("en-IN").format(totalCost1 * totalTraveler)}
        </p>
        ...
        >
          ...
          <button onClick={completeBooking1}>Book</button>
        </div>
      </div>
...
export default FlightResultMulti1;
